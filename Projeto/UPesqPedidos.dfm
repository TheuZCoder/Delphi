object FrmUPesqPedidos: TFrmUPesqPedidos
  ...
  object DBGPrincipal: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'PK_PEDIDOS'
        Title.Caption = 'NUMERO PEDIDO'
        Width = 240
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'PDDDATEPED'
