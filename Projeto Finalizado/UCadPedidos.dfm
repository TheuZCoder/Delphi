object FrmUCadPedidos: TFrmUCadPedidos
  ...
  object QCadPedido: TFDQuery
    ...
    SQL.Strings = (
      'SELECT * FROM T_SAVPROD  ORDER BY Svp_CodTmp')
    Left = 96
    Top = 232
    object QCadPedidoSVP_CODTMP: TStringField
      DisplayLabel = 'C'#243'digo Produto'
      DisplayWidth = 25
      FieldName = 'SVP_CODTMP'
      Origin = 'SVP_CODTMP'
      Size = 50
    end
    object QCadPedidoSVP_QTD: TFMTBCDField
    ...
    object QCadPedidoSVP_VALPRD: TFMTBCDField
      DisplayLabel = 'Valor Unitario'
      DisplayWidth = 25
      FieldName = 'SVP_VALPRD'
      Origin = 'SVP_VALPRD'
      DisplayFormat = '#,##0.00'
      Precision = 38
      Size = 38
    end
    object QCadPedidoSVP_VALITN: TFMTBCDField
      DisplayLabel = 'Valor Total'
      DisplayWidth = 25
      FieldName = 'SVP_VALITN'
      Origin = 'SVP_VALITN'
      DisplayFormat = '#,##0.00'
      Precision = 38
      Size = 38
